...
namespace Catalog.Api.Data
{
    public class CatalogInitialData : IInitialData
    {
        ...
        {
            // creating light weight session 
            using var session = store.LightweightSession();

            // unsing light weight session to query database if there is any product in there or not, if then return otherwise do seeding data
